                                ...
                                <div className={cn(className && className)}>
                                    <Container flexContainer={'column'}>
                                        {(data.allMdx.edges as Edge[]).map(({node}) => {
                                            return (
                                                <Container className={cn(pb24)} flexContainer={'column'}
                                                           key={node.frontmatter.path}>
                                                    <ContentText className={cn(pb4, pl8)}>
                                                        <Molecule>
                                                            <Button style={'none'} to={node.frontmatter.path}>
                                                                <h6 className={cn('font-p is-semibold')}>{node.frontmatter.title}</h6>
                                                            </Button>
                                                        </Molecule>
                                                    </ContentText>
                                                    <Container flexContainer={'column'} className={cn(pl24)}>
                                                        <ContentText>
                                                            <Molecule>
                                                                <p className={cn('font-p-small')}>{node.frontmatter.description}</p>
                                                            </Molecule>
                                                        </ContentText>
                                                    </Container>
                                                </Container>
